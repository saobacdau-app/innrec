...
sed -i -e "s/NOTIFI_URI/$NOTIFI_URI/g" /opt/rtpengine/rtpengine-recording.conf
sed -i -e "s/OUTPUT_MIXED/$OUTPUT_MIXED/g" /opt/rtpengine/rtpengine-recording.conf
sed -i -e "s/OUTPUT_SINGLE/$OUTPUT_SINGLE/g" /opt/rtpengine/rtpengine-recording.conf
